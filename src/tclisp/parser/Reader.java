...
public class Reader extends TCLispBaseVisitor<Object> {
    ...
    @Override
    public QuotationNode visitQuote(MumblerParser.QuoteContext ctx) {
        return new QuotationNode((TCLispNode)this.visit(ctx.form()));
    }
